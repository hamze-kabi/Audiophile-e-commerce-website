    ...
    <div class="flex flex-col items-center justify-center md:flex-row xl:mx-30">
      ...
      <picture>
        <source
          ...
          :srcset="prepend + props.product.images.productPageDesktop"
        />
        <source
          media="(min-width:768px)"
          :srcset="prepend + props.product.images.productPageTablet"
        />
        <img
          class="w-90/100 mx-auto my-5 basis-1/3"
          :src="prepend + props.product.images.productPageMobile"
